...
DEMO_CATALOG = [
    {"id": 1, "title": "Ultra-light Performance Mechanical Keyboard", "category": "Electronics", "price": 129.99, "keywords": ["keyboard", "mechanical", "switch", "rgb", "typing"]},
    {"id": 2, "title": "Ergonomic Mesh High-Back Office Chair", "category": "Furniture", "price": 289.00, "keywords": ["chair", "ergonomic", "desk", "lumbar", "mesh", "office"]},
    {"id": 3, "title": "Noise-Cancelling Studio Wireless Headphones", "category": "Audio", "price": 199.50, "keywords": ["headphone", "audio", "sound", "noise", "wireless", "music"]},
    {"id": 4, "title": "4K Ultra HD IPS 27-inch Developer Monitor", "category": "Electronics", "price": 449.99, "keywords": ["monitor", "display", "screen", "4k", "ips", "usb-c"]}
]
